...
- [ ] Explain what a token is used for.
        Authenticating a user so that they can go inside Private Routes
- [ ] What steps can you take in your web apps to keep your data secure?
        Don't asign tokens to local storage.
- [ ] Describe how web servers work.
        Stores code for different websites and has code that tells the server what to do
